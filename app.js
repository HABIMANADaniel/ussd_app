...
const dbConfig = {
    host: 'bqe7vvhtnqld16r7qaye-mysql.services.clever-cloud.com',
    user: 'ullzmslv4odqyxiu',
    password: 'xSVTo1cv7J6R1YmR7mjy', // Replace with your MySQL password
    database: 'bqe7vvhtnqld16r7qaye'
};
